...
const Expertise = () => {
  return (
    <div
      className="bg-[#F8F9FA] dark:bg-[#0D1116] px-8 text-black dark:text-white  py-10"
      id="expertise"
    >
      <div className="flex flex-col gap-5 items-start lg:max-w-[1000px] mx-auto">
        ...
        <span>
          Je crée des sites web avec WordPress, du recueil du besoin à la mise
          en ligne, en passant par l'optimisation de la performance et du
          référencement.
        </span>
        ...
        <span>
          ...
          (Sites web, fiches Google, réseaux sociaux) en assurant leur
          performance technique, leur conformité aux standards actuels et leur
          pertinence stratégique pour les objectifs d'entreprise.
        </span>
